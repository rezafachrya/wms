...
extension DateTimeExtension on DateTime {
  String get getAppDate => "${this.year}-${this.month}-${this.day}";
  ...
  String get getAppTime => (this.hour <= 9)
      ? (this.minute <= 9)
          ? "0${this.hour}:0${this.minute}:${this.second} WIB"
          : "0${this.hour}:${this.minute}:${this.second} WIB"
      : (this.minute <= 9)
          ? "${this.hour}:0${this.minute}:${this.second} WIB"
          : "${this.hour}:${this.minute}:${this.second} WIB";
